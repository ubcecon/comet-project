...
test_1 <- function() {
  test_that("Solution is incorrect. Hint: remember the interaction variables?", {
    expect_equal(digest(summary(reg1$coefficients[["(Intercept)"]])), 'd6e840176dd67eac6fe81b7743ae36e1')
  })
  print("Success!")
}
test_1.5 <- function() {
  test_that("Solution is incorrect", {
    expect_equal(digest(reg2$coefficients[["(Intercept)"]]), '1ba10f2c9029d5ab2a3669e90ee65056')
  })
  print("Success!")
}
test_2 <- function() {
  test_that("Solution is incorrect", {
    expect_equal(digest(reg3A$coefficients[["(Intercept)"]]), 'e6356b636625ff42aa58191daccdae4a')
  })
  print("Success!")
}
...
test_3 <- function() {
  test_that("Solution is incorrect", {
    expect_equal(digest(reg3M$coefficients[["(Intercept)"]]), 'da3ece4cc09b906df9d13c115bd6432d')
  })
  print("Success!")
}
...
test_4 <- function() {
  test_that("Solution is incorrect", {
    expect_equal(digest(reg3F$coefficients[["(Intercept)"]]), '1b10dece2f11c6b3cf38648f1cadff7d')
  })
  print("Success!")
}
...
test_5 <- function() {
  test_that("Solution is incorrect. Hint: interactions?", {
    expect_equal(digest(reg4$coefficients[["(Intercept)"]]), '9a2a78cfc05ecb52a6816c835c92c2cc')
  })
  print("Success!")
}
