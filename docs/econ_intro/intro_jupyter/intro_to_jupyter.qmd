...
description: Welcome to COMET!  This is the very first notebook most of you will, and it introduces you to some basics of Jupyter and using this project.  Have fun!
categories: [introduction, econ intro, jupyter, basics]
format: 
  html: default
  ipynb:
    jupyter:
